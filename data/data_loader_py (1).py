...
class ClinicalDataLoader:
    ...
    def get_target_column(self) -> str:
        ...
        if 'data' in self.config and 'target_column' in self.config['data']:
            ...
            raise ValueError("Target column not specified in configuration")
    ...
    def get_data_summary(self, data: Optional[pd.DataFrame] = None) -> Dict[str, Any]:
        ...
        summary = {
            ...
            'data_types': data.dtypes.to_dict(),
            'numerical_summary': data.describe().to_dict() if not data.select_dtypes(include=[np.number]).empty else {},
            'categorical_summary': {}
        }
        ...
        try:
            ...
            if target_col in data.columns:
                summary['target_distribution'] = data[target_col].value_counts().to_dict()
        except ValueError:
            pass
